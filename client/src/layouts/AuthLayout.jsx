...
export default function AuthLayout({ children, type = "login" }) {
  return (
    <div className="min-h-screen flex bg-[var(--bg)] text-[var(--text)]">
      ...
      {/* FORM SECTION */}
      <div className="w-full md:w-1/2 flex items-center justify-center px-5 sm:px-8 md:px-12 py-8 sm:py-10">
        <div className="w-full max-w-md">
          {children}
        </div>
      </div>

      {/* INFO PANEL - DESKTOP/TABLET ONLY */}
      <div
        className="hidden md:flex w-1/2 relative flex-col justify-center
        px-16 bg-[var(--surface)] border-l border-[var(--border)]"
      >
